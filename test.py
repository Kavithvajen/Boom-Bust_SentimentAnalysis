...
if __name__ == "__main__":
    ...
    print("Text results written in the file 'sentenceAnalysis.txt'.")
    writeToJSON(sentenceAnalysis)
    print("JSON results written in the file 'sentenceAnalysis.json'.")
